...
var Controller = StateMachine.create({
    ...
    events: [
        ...
        {
            name: 'rest',
            from: ['draggingStart1', 'draggingEnd1', 'draggingStart2', 'draggingEnd2', 'drawingWall', 'erasingWall'],
            to  : 'ready'
        },
    ],
});
...
$.extend(Controller, {
    ...
    onsearch: function(event, from, to) {
        ...
        this.path = finder.findPath(
            this.startX1, this.startY1, this.endX1, this.endY1, this.startX2, this.startY2, this.endX2, this.endY2, grid
        );
    ...
    mousedown: function (event) {
        ...
        if (this.can('dragStart1') && this.isStartPos1(gridX, gridY)) {
            this.dragStart1();
            return;
        }
        if (this.can('dragEnd1') && this.isEndPos1(gridX, gridY)) {
            this.dragEnd1();
            return;
        }
        if (this.can('dragStart2') && this.isStartPos2(gridX, gridY)) {
            this.dragStart1();
            return;
        }
    ...
    mousemove: function(event) {
        ...
        case 'draggingStart1':
            if (grid.isWalkableAt(gridX, gridY)) {
                this.setStartPos1(gridX, gridY);
            }
            break;
        case 'draggingEnd1':
            if (grid.isWalkableAt(gridX, gridY)) {
                this.setEndPos1(gridX, gridY);
            }
            break;
        case 'draggingStart2':
            if (grid.isWalkableAt(gridX, gridY)) {
                this.setStartPos2(gridX, gridY);
            }
            break;
        case 'draggingEnd2':
            if (grid.isWalkableAt(gridX, gridY)) {
    ...
    setStartPos1: function(gridX, gridY) {
        this.startX1 = gridX;
        this.startY1 = gridY;
        View.setStartPos1(gridX, gridY);
    },
    setEndPos1: function(gridX, gridY) {
        this.endX1 = gridX;
        this.endY1 = gridY;
        View.setEndPos1(gridX, gridY);
    },
    setStartPos2: function(gridX, gridY) {
        this.startX2 = gridX;
        this.startY2 = gridY;
        View.setStartPos2(gridX, gridY);
    },
    ...
    isStartPos1: function(gridX, gridY) {
        return gridX === this.startX1 && gridY === this.startY1;
    },
    isEndPos1: function(gridX, gridY) {
        return gridX === this.endX1 && gridY === this.endY1;
    },
    isStartPos2: function(gridX, gridY) {
        return gridX === this.startX2 && gridY === this.startY2;
    },
    isEndPos2: function(gridX, gridY) {
        return gridX === this.endX2 && gridY === this.endY2;
    },
    isStartOrEndPos: function(gridX, gridY) {
        return this.isStartPos1(gridX, gridY) || this.isEndPos1(gridX, gridY) || this.isStartPos2(gridX, gridY) || this.isEndPos2(gridX, gridY);
    },
});
